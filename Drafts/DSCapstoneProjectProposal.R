...
#Reference
library(ggplot2)
ggplot(s2023sub, aes(x = bpm, y = streamsClean), na.rm = TRUE) + geom_point() + geom_smooth(method = 'lm') +
  ggtitle('Relationship between streams and bpm') + labs(x = 'bpm', y = 'Streams')
ggplot(s2023sub, aes(x = danceability, y = streamsClean), na.rm = TRUE) + geom_point() + geom_smooth(method = 'lm') +
  ggtitle('Relationship between streams and danceability') + labs(x = 'Danceability', y = 'Streams')
ggplot(s2023sub, aes(x = valence, y = streamsClean), na.rm = TRUE) + geom_point() + geom_smooth(method = 'lm') +
  ggtitle('Relationship between streams and valence') + labs(x = 'Valence', y = 'Streams')
ggplot(s2023sub, aes(x = energy, y = streamsClean), na.rm = TRUE) + geom_point() + geom_smooth(method = 'lm') +
  ggtitle('Relationship between streams and energy level') + labs(x = 'Energy', y = 'Streams')
ggplot(s2023sub, aes(x = speechiness, y = streamsClean), na.rm = TRUE) + geom_point() + geom_smooth(method = 'lm') +
  ggtitle('Relationship between streams and speechiness') + labs(x = 'Speechines', y = 'Streams')
